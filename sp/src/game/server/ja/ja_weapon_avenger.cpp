...
class CWeaponAvenger : public CHeatsinkMachineGun
{
	DECLARE_DATADESC();
public:
	DECLARE_CLASS( CWeaponAvenger, CHeatsinkMachineGun );
...
void CWeaponAvenger::ItemPostFrame( void )
{
